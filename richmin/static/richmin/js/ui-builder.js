(function ($) {
    ...
    const $body = $('body');
    const $footer = $('footer');
    const $sidebar_ul = $('aside#richy-sidebar nav ul:first-child');
    const $sidebar = $('aside#richy-sidebar');
    const $navbar = $('nav#richy-navbar');
    const $logo = $('#richy-logo');
    const $actions = $('#richy-actions');
    const buttons = [
        "primary",
        "secondary",
        "info",
    ...
    function miscListeners() {
        ...
        $("#codeBox").on('show.bs.modal', function () {
            $('.modal-body code', this).html(
                'RICHMIN_UI_TWEAKS = ' + JSON.stringify(
    ...
    function buttonStyleListeners() {
        buttons.forEach(function(btn) {
            $("#richmin-btn-style-" + btn).on('change', function () {
    ...
    function setFromExisting() {
        ...
        // set button styles
        buttons.forEach(function(btn) {
            $("#richmin-btn-style-" + btn).val(window.ui_changes['button_classes'][btn]);
        });
