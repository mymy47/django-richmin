...
@register.simple_tag
def richmin_paginator_number(change_list: ChangeList, i: int) -> SafeText:
    """
...
@register.simple_tag
def richmin_list_filter(cl: ChangeList, spec: ListFilter) -> SafeText:
    """
