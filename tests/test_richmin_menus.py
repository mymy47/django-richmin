...
def test_side_menu(admin_client, custom_richmin_settings):
    """
...
@pytest.mark.django_db
def test_permissions_on_custom_links(client, custom_richmin_settings):
    """
...
@pytest.mark.django_db
def test_top_menu(admin_client, custom_richmin_settings):
    """
...
@pytest.mark.django_db
def test_user_menu(admin_user, client, custom_richmin_settings):
    """
    ...
    assert parse_usermenu(response) == [
        ...
        {
            'link': f'/en/admin/auth/user/{admin_user.pk}/change/',
            'name': 'See Profile',
        },
    ]
